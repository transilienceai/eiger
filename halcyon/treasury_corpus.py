...
SCENARIOS: dict[str, Scenario] = {
    ...
    "payroll": Scenario(
        key="payroll",
        brief="Pending: 18,500 in compensatory adjustments across three employee accounts.",
...
# Policy lines grouped by topic. Each scenario-specific bucket competes against
# the generic control-cluster and retail-banking policies. Density is balanced
# across vendor, payroll, wire, and escrow.
_TOPICS: dict[str, list[str]] = {
    ...
    "escrow": [
        ...
        "Escrow disputes are escalated to legal counsel within five business days of notification.",
        "Escrow release documentation must be retained for audit purposes.",
        "Escrow fund reconciliation tolerances are reviewed quarterly by the settlements team.",
    ],
    "generic": [
