...
**Instructor reference material (includes solutions and implementation details):** `../STATUS.md` (build status + honeytokens/markers), `../e2e/*.md` (per-module live-proof evidence with exact proven payloads), `../m4-instructor-demo.md` (the sandboxed pickle-RCE demo), `../../OPERATIONS.md` (deploy/run).
